...
axiosInstance.interceptors.request.use(async (config) => {
  ...
  config.headers['X-App-Source'] = 'vite';
  return config
})
...
export const insertTexts = async (texts: string[]): Promise<DocActionResponse> => {
  const response = await axiosInstance.post(`${backendBaseUrl}/documents/texts`, { texts })
  return response.data
}
...
export const uploadDocument = async (
  ...
  const response = await axiosInstance.post(`${backendBaseUrl}/documents/upload`, formData, {
    headers: {
...
export const clearDocuments = async (): Promise<DocActionResponse> => {
  const response = await axiosInstance.delete(`${backendBaseUrl}/documents`)
  return response.data
}
...
export const clearCache = async (modes?: string[]): Promise<{
  ...
  const response = await axiosInstance.post(`${backendBaseUrl}/documents/clear_cache`, { modes })
  return response.data
}

export const deleteDocuments = async (docIds: string[], deleteFile: boolean = false): Promise<DeleteDocResponse> => {
  const response = await axiosInstance.delete(`${backendBaseUrl}/documents/delete_document`, {
...
export const updateEntity = async (
  ...
  const response = await axiosInstance.post(`${backendBaseUrl}/graph/entity/edit`, {
...
export const updateRelation = async (
  ...
  const response = await axiosInstance.post(`${backendBaseUrl}/graph/relation/edit`, {
...
export const checkEntityNameExists = async (entityName: string): Promise<boolean> => {
  try {
    const response = await axiosInstance.get(`${backendBaseUrl}/graph/entity/exists?name=${encodeURIComponent(entityName)}`)
