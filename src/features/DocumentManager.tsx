...
import UploadTextDialog from '@/components/documents/UploadTextDialog'
    ...
    <Card className="!rounded-none !overflow-hidden flex flex-col h-full min-h-0">
      ...
      <CardContent className="flex-1 flex flex-col min-h-0 overflow-auto">
        <div className="flex gap-2 mb-2">
          ...
          <UploadTextDialog onTextInserted={fetchDocuments} />

          {/* <Button
                    size="sm"
                    variant={'secondary'}
                   // onClick={() => setStatusFilter('all')}
                    className={cn('bg-gray-100 dark:bg-gray-900 font-medium border border-gray-400 dark:border-gray-500 shadow-sm'
                    )}
                  >
                    Query Text
                  </Button> */}
