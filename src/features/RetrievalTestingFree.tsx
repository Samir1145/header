...
export default function RetrievalTestingFree() {
    ...
    const handleSubmit = useCallback(async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (state.querySettings.stream) {
                let streamError = ''
                await queryFreeTextStream(backendFreeBaseUrl,queryParams, (chunk) => {
                    fullAnswer += chunk
                ...
                const response = await queryFreeText(backendFreeBaseUrl,queryParams)
